...
of Type LSTM
two sequential LSTM layers with 128 neurons
...
def get_model(x_train):
    ...
    with strategy.scope():
        ...
        model.add(LSTM(128, input_shape=(x_train.shape[1], x_train.shape[2]),dropout = dp_lvl,recurrent_dropout = dp_lvl, return_sequences =  True ))
        ...
        model.add(Dense(x_train.shape[2], activation='tanh',activity_regularizer=regularizers.l2(regularizer_lvl)))
